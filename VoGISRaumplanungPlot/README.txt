...
Your plugin VoGISRaumplanungPlot was created in:
    /home/user/VoGIS-Raumplanung/VoGISRaumplanungPlot
...
What's Next:
  ...
  * Customize it by editing the implementation file:
         vogisraumplanungplot.py

  * Create your own custom icon, replacing the default icon.png

  * Modify your user interface by opening vogisraumplanungplot.ui
